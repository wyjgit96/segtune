import re
from src.g2p.g2p.mandarin import chinese_to_ipa
from src.g2p.g2p.english import english_to_ipa
from src.g2p.g2p.french import french_to_ipa
from src.g2p.g2p.korean import korean_to_ipa
from src.g2p.g2p.german import german_to_ipa
